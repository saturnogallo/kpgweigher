...
sbit LCD_WR =P0^4;  //Data Write into T6963C,L有效
sbit LCD_RD =P0^3;  //Data Read from T6963C,L有效
sbit LCD_CE =P0^2;  //使能信号，L有效
sbit LCD_CD =P0^1;  //当wr=L,LCD_CD=H:写命令,LCD_CD=L:写数据;当rd=L,LCD_CD=H:读状态,LCD_CD=L:读数据
sbit LCD_RST=P0^0;  //Lcm reset,低有效
sbit LCD_FS =P0^5;  //字体选择,H:6*8点阵;L:8*8点阵
