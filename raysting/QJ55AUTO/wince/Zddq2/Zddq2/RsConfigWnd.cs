...
namespace Zddq2
{
    public partial class RsConfigWnd : Form
    {
        ...
        public RsConfigWnd()
        {
            ...
            dataGrid2.DataSource = rs_dt;
            dataGrid2.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Bold);
            dataGrid2.CellDoubleClick += new DataGridCellEventHandler(dataGrid2_CellDoubleClick);
             * 
             *         void dataGrid2_CellDoubleClick(object sender, DataGridCellEventArgs e)
        {
