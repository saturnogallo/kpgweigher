...
class _Application2 : public COleDispatchDriver
{
public:
	_Application2() {}		// Calls COleDispatchDriver default constructor
	_Application2(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	_Application2(const _Application2& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	long GetCount();
	void Delete();
	void FillAcrossSheets(LPDISPATCH Range2, long Type);
	LPDISPATCH GetItem(const VARIANT& Index);
	void Move(const VARIANT& Before, const VARIANT& After);
	LPUNKNOWN Get_NewEnum();
	void PrintPreview(const VARIANT& EnableChanges);
...
/////////////////////////////////////////////////////////////////////////////
// Range2 wrapper class

class Range2 : public COleDispatchDriver
{
public:
	Range2() {}		// Calls COleDispatchDriver default constructor
	Range2(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	Range2(const Range2& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
