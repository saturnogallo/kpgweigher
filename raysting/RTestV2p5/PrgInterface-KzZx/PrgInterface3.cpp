...
PRGINTERFACE_API const char*  PathQuery(int pathid, int clsid)
{
	const char*	pathdef[]={
		...
		/*REG	*/	"reg",		"*",							"16505zx",	
		/*DATA	*/	"data",	"*",	"*",	
		/*JH	*/	"jh",		"\\Html\\imgorg\\16505zxjh.htm",		"16505zx",	
		/*REPORT*/	"*",		"*",							"*",	
		/*TEST	*/	"*",		"\\Html\\imgorg\\16505zxtest.htm",	"*",	
		/*CONF	*/	"conf",		"*",							"conf",	
		/*TBR	*/	"*",		"*",			"*",	
		/*WAIT  */	"*",		"\\Html\\wait.htm",				"*",
		/*TYPE*/  	"*",        "宽范围电阻箱",							"宽范围电阻箱测量"
	};        
...
PRECBASE2 g_Cfg[] = {
	...
	{PREC_TYPE_RGROUP,191,201,190,"100","jhsel8",JHSEL_0005_50,"-10",MANTI_13_1,PREC_5E5_5E1,NULL,"X100000ohm盘第{rel_pos}点不合格"},
	{PREC_TYPE_RGROUP,211,221,210,"1","jhsel9",JHSEL_0005_50,"-16",MANTI_13_1,PREC_5E5_5E1,NULL,"X1000000ohm盘第{rel_pos}点不合格"},


	
	{PREC_TYPE_RCAN,19,19,0,"-0.02,0.001,0.01,0.1,1,10,100,1000,10000,100000,1000000","jhsel0,jhsel1,jhsel2,jhsel3,jhsel4,jhsel5,jhsel6,jhsel7,jhsel8,jhsel9","1","-4","1","1","Z31,Z51,Z71,Z91,Z111,Z131,Z151,Z171,Z191,Z211","残余电阻不合格"},
	{PREC_TYPE_BIANCHA,17,17,0,"-0.02,0.001,0.01,0.1,1,10,100,1000,10000,100000,1000000","jhsel0,jhsel1,jhsel2,jhsel3,jhsel4,jhsel5,jhsel6,jhsel7,jhsel8,jhsel9","1","-4","1","1","Z31,Z51,Z71,Z91,Z111,Z131,Z151,Z171,Z191,Z211","开关变差不合格"},
	...
	{PREC_TYPE_FORMAT,202,202,0,"-0.01","1",NULL,"-4,","1,","1,",NULL,"X100000ohm盘变差不合格"},
	{PREC_TYPE_FORMAT,222,222,0,"-0.01","1",NULL,"-4,","1,","1,",NULL,"X1000000ohm盘变差不合格"},
...
PRGINTERFACE_API void  PrepareArrayForReport(CMapStringToString &mstr)
{
	...
	_T("0.001Ω"),_T("0.01Ω"),_T("0.1Ω"),_T("1Ω"),_T("10Ω"),_T("100Ω"),_T("1000Ω"),_T("10000Ω"),_T("100000Ω"),_T("1000000Ω")};
	...
	for ( grpindex = 0;grpindex < 10;grpindex++)
