...
PRGINTERFACE_API const char*  PathQuery(int pathid, int clsid)
{
	const char*	pathdef[]={
		...
		/*REG	*/	"reg",			"*",						"zx82a",	
		/*DATA	*/	"data",	"*",	"*",	
		/*JH	*/	"jh",		"\\Html\\imgorg\\zx82ajh.htm",	"zx82a",	
		/*REPORT*/	"*",		"*",							"*",	
		/*TEST	*/	"*",		"\\Html\\imgorg\\zx82atest.htm",	"*",	
		/*CONF	*/	"conf",		"*",							"conf",	
		/*TBR	*/	"*",		"*",							"*",	
		/*WAIT  */	"*",		"\\Html\\wait.htm",				"*",
		/*TYPE*/  	"*",        	"ZX82A",				    "ZX82A型接地电阻表检定电阻器测量"
	};        
...
PRECBASE2 g_Cfg[] = {
	...
	{PREC_TYPE_RSINGLE,34,34,0,"10000000","jhsel17",JHSEL_0005_10,"-13",MANTI_11_1,PREC_5E5_1E1,NULL,"x10M 转盘不合格"},
	{PREC_TYPE_RSINGLE,35,35,0,"500000","jhsel9",JHSEL_0005_10,"-1",MANTI_11_1,PREC_5E5_1E1,NULL,"x500k 转盘不合格"},

	{PREC_TYPE_RSINGLE,36,36,0,"50000","jhsel8",JHSEL_0005_10,"-4",MANTI_11_1,PREC_5E5_1E1,NULL,"x50k 转盘不合格"},
	{PREC_TYPE_RSINGLE,37,37,0,"5000","jhsel7",JHSEL_0005_10,"-7",MANTI_11_1,PREC_5E5_1E1,NULL,"x5k 转盘不合格"},
