...
const char* CDwcjHandler::PathQuery(int clsid,int pathid)
{
	const char*	pathdef[][3]={
				/*MDB*/		/*JS*/							/*GROUP*/
	/*REG	*/	"reg",		"\\Html\\imgorg\\reg.js",		"*",	
	/*DATA	*/	"dwcjdata",	"\\Html\\imgorg\\dwcjdata.js",	"*",	
	/*JH	*/	"jh",		"\\Html\\imgorg\\dwcjjh.js",	"dwcj",	
	/*REPORT*/	"*",		"\\Html\\imgorg\\report.js",	"*",	
	/*TEST	*/	"*",		"\\Html\\imgorg\\dwcjtest.js",	"*",	
	/*CONF1	*/	"conf",		"\\Html\\imgorg\\zxconf1.js",	"dwcjconf1",	
	/*CONF2	*/	"conf",		"\\Html\\imgorg\\zxconf2.js",	"dwcjconf2",	
...
bool CDwcjHandler::Handler(CString spage,CString op,CString scmd)
{
	return CHtmlHandler::Handler(spage,op,scmd);
}

bool CDwcjHandler::ReportHandler(CString op,CString scmd)
{	
	return CHtmlHandler::ReportHandler(op,scmd);
}
bool CDwcjHandler::DataHandler(CString op,CString scmd)
{
...
bool CDwcjHandler::JhHandler(CString op,CString scmd)
{
	return CHtmlHandler::JhHandler(op,scmd);
}
bool CDwcjHandler::TestHandler(CString op,CString scmd)
{
	return CHtmlHandler::TestHandler(op,scmd);
}

bool CDwcjHandler::Configure1Handler(CString op,CString scmd)
{
	return CHtmlHandler::Configure1Handler(op,scmd);
}
bool CDwcjHandler::Configure2Handler(CString op,CString scmd)
{
	return CHtmlHandler::Configure2Handler(op,scmd);
}

bool CDwcjHandler::RegHandler(CString op,CString scmd)
{
...
void CDwcjHandler::DataIntegrateForCheck(CMapStringToString& mstr,int indexmax,bool colormark)
{
...
void CDwcjHandler::DataIntegrateForCompensate(CMapStringToString& mstr,int indexmax)
{
	mstr.SetAt("0.005","0");	mstr.SetAt("0.01","1");	mstr.SetAt("0.02","2");
	mstr.SetAt("0.05","3");		mstr.SetAt("0.1","4");	mstr.SetAt("0.2","5");
	mstr.SetAt("0.5","6");		mstr.SetAt("1","7");	mstr.SetAt("2","8");
...
void CDwcjHandler::PrepareArrayForReport(CMapStringToString& mstr)
{
