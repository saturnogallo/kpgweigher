...
const char* CDz3Handler::PathQuery(int clsid,int pathid)
{
	const char*	pathdef[][3]={
				/*MDB*/		/*JS*/							/*GROUP*/
	/*REG	*/	"reg",		"\\Html\\imgorg\\reg.js",		"*",	
	/*DATA	*/	"dz3data",	"\\Html\\imgorg\\dz3data.js",	"*",	
	/*JH	*/	"jh",		"\\Html\\imgorg\\dz3jh.js",		"dz3",	
	/*REPORT*/	"*",		"\\Html\\imgorg\\report.js",	"*",	
	/*TEST	*/	"*",		"\\Html\\imgorg\\dz3test.js",	"*",	
	/*CONF1	*/	"conf",		"\\Html\\imgorg\\zxconf1.js",	"dz3conf1",	
	/*CONF2	*/	"conf",		"\\Html\\imgorg\\zxconf2.js",	"dz3conf2",	
...
bool CDz3Handler::Handler(CString spage,CString op,CString scmd)
{
	return CHtmlHandler::Handler(spage,op,scmd);
}

bool CDz3Handler::ReportHandler(CString op,CString scmd)
{	
...
bool CDz3Handler::JhHandler(CString op,CString scmd)
{
	return CHtmlHandler::JhHandler(op,scmd);
}
bool CDz3Handler::TestHandler(CString op,CString scmd)
{
	return CHtmlHandler::TestHandler(op,scmd);
}

bool CDz3Handler::Configure1Handler(CString op,CString scmd)
{
	return CHtmlHandler::Configure1Handler(op,scmd);
}
bool CDz3Handler::Configure2Handler(CString op,CString scmd)
{
	return CHtmlHandler::Configure2Handler(op,scmd);
}

bool CDz3Handler::RegHandler(CString op,CString scmd)
{
