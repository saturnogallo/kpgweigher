...
document.writeln("		<td ><button type='button' onclick=reportsubmit('tbsavenew')>另存为..</td>  ");
document.writeln("		<td ><font color='green'>|</font></td>  ");
document.writeln("		<td ><button type='button' onclick=reportsubmit('tbprint')>打印报告</td>  ");
document.writeln("		<td ><font color='green'>|</font></td>  ");
