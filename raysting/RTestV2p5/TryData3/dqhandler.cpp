...
const char* CDqHandler::PathQuery(int clsid,int pathid)
{
	const char*	pathdef[][3]={
				/*MDB*/		/*JS*/							/*GROUP*/
	/*REG	*/	"reg",		"\\Html\\imgorg\\reg.js",		"*",	
	/*DATA	*/	"dqdata",	"\\Html\\imgorg\\dqdata.js",	"*",	
	/*JH	*/	"jh",		"\\Html\\imgorg\\dqjh.js",		"dq",	
	/*REPORT*/	"*",		"\\Html\\imgorg\\report.js",	"*",	
	/*TEST	*/	"*",		"\\Html\\imgorg\\dqtest.js",	"*",	
	/*CONF1	*/	"conf",		"\\Html\\imgorg\\zxconf1.js",	"dqconf1",	
	/*CONF2	*/	"conf",		"\\Html\\imgorg\\zxconf2.js",	"dqconf2",	
...
bool CDqHandler::Handler(CString spage,CString op,CString scmd)
{
	return CHtmlHandler::Handler(spage,op,scmd);
}

bool CDqHandler::ReportHandler(CString op,CString scmd)
{	
	return CHtmlHandler::ReportHandler(op,scmd);
}
bool CDqHandler::DataHandler(CString op,CString scmd)
{
...
bool CDqHandler::JhHandler(CString op,CString scmd)
{
	return CHtmlHandler::JhHandler(op,scmd);
}
bool CDqHandler::TestHandler(CString op,CString scmd)
{
	return CHtmlHandler::TestHandler(op,scmd);
}

bool CDqHandler::Configure1Handler(CString op,CString scmd)
{
	return CHtmlHandler::Configure1Handler(op,scmd);
}
bool CDqHandler::Configure2Handler(CString op,CString scmd)
{
	return CHtmlHandler::Configure2Handler(op,scmd);
}

bool CDqHandler::RegHandler(CString op,CString scmd)
{
...
void CDqHandler::DataIntegrateForCheck(CMapStringToString& mstr,int indexmax,bool colormark)
{
...
void CDqHandler::DataIntegrateForCompensate(CMapStringToString& mstr,int indexmax)
{
	mstr.SetAt("0.005","0");	mstr.SetAt("0.01","1");	mstr.SetAt("0.02","2");
	mstr.SetAt("0.05","3");		mstr.SetAt("0.1","4");	mstr.SetAt("0.2","5");
	mstr.SetAt("0.5","6");		mstr.SetAt("1","7");	mstr.SetAt("2","8");
...
void CDqHandler::PrepareArrayForReport(CMapStringToString& mstr)
{
