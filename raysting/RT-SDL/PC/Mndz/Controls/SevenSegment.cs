...
namespace Mndz
{
    public class SevenSegment : UserControl
    {
        public SevenSegment()
        {
            ...
            this.Size = new System.Drawing.Size(32, 165);
            ...
            this.TabStop = false;
            this.Padding = new Mndz.Padding(10, 4, 10, 4);
            //sojo this.DoubleBuffered = true;
        ...
        private Mndz.Padding _Padding;
        public Mndz.Padding Padding {
            get{
                return _Padding;
            }
            set{
        ...
        public int gridHeight = 165; //should be maximum height
        ...
        private Color colorDark = Color.WhiteSmoke;
        ...
        //by sojo protected override void OnPaddingChanged(EventArgs e) { base.OnPaddingChanged(e); this.Invalidate(); }
        ...
        private void SevenSegment_Paint(object sender, PaintEventArgs e)
        {
            ...
            if ((backBuffer == null) || (this.gridWidth != backBuffer.Width) || (this.gridHeight != backBuffer.Height))
            {
                backBuffer = new Bitmap(this.gridWidth, this.gridHeight);
...
//            RectangleF destRect = new RectangleF(Padding.Left, Padding.Top, this.Width - Padding.Left - Padding.Right, this.Height - Padding.Top - Padding.Bottom);
            ...
            */
            ...
            graphic.FillPolygon((useValue & 0x1) == 0x1 ? brushLight : brushDark, segPoints[0]);
            graphic.FillPolygon((useValue & 0x2) == 0x2 ? brushLight : brushDark, segPoints[1]);
            graphic.FillPolygon((useValue & 0x4) == 0x4 ? brushLight : brushDark, segPoints[2]);
            graphic.FillPolygon((useValue & 0x8) == 0x8 ? brushLight : brushDark, segPoints[3]);
            graphic.FillPolygon((useValue & 0x10) == 0x10 ? brushLight : brushDark, segPoints[4]);
            graphic.FillPolygon((useValue & 0x20) == 0x20 ? brushLight : brushDark, segPoints[5]);
            graphic.FillPolygon((useValue & 0x40) == 0x40 ? brushLight : brushDark, segPoints[6]);
