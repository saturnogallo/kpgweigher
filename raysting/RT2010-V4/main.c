...
while(1)
{          
        sprintf(strbuf,"SPORT0");
        prints(strbuf,strlen(strbuf),SPORT0); 
        sprintf(strbuf,"SPORT1");
        prints(strbuf,strlen(strbuf),SPORT1); 
        sprintf(strbuf,"SPORTA");
        prints(strbuf,strlen(strbuf),SPORTA); 
        sprintf(strbuf,"SPORTB");
        prints(strbuf,strlen(strbuf),SPORTB); 
        sprintf(strbuf,"SPORTC");
        prints(strbuf,strlen(strbuf),SPORTC); 
        sprintf(strbuf,"SPORTD");
        prints(strbuf,strlen(strbuf),SPORTD); 
        sleepms(200*ONEMS);        
}
#endif
