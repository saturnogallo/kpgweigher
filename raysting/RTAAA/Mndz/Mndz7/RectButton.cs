...
namespace Mndz7
{
    public enum MyButtonType
    {
        ...
        triangleupButton, //triangle up button
        trianglednButton, //triangle down button
        trianglelfButton, //triangle left button
        trianglertButton, //triangle right button
    ...
    public partial class RectButton : UserControl
    {
        ...
        {
//            timeout.Stop();
            if ((colorSave == colorTop) || (colorSave == Color.Tan))
                return;
            colorTop = colorSave;
            this.Invalidate();
        }
        ...
        private Color colorSave = Color.Tan;
        ...
        private Point[] trian_pts = new Point[3];
        private void DrawTriangle(Graphics g, Brush br, Rectangle area)
        {
            ...
            else if (btnType == MyButtonType.triangleupButton)
            {
                trian_pts[1].X = area.Left + area.Width / 2;
            }
            else if (btnType == MyButtonType.trianglertButton)
            {
                trian_pts[1].X = area.Left;
                trian_pts[2].Y = area.Top + area.Height / 2;
            }
            else if (btnType == MyButtonType.trianglednButton)
            {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                DrawTriangle(graphic, myBotPen, areaBottom);
                DrawTriangle(graphic, myTopPen, areaTop);
            }
