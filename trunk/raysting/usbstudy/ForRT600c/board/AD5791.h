...
#define DACMD_OUTPUT	0x01
#define DACMD_HWCLR		0x02
#define DACMD_HWRST		0x03
#define DACMD_RESCUE	0x04
unsigned char cm_ad5791(unsigned char temp, double val);
unsigned char cm_ad5791b();
void AD5791Init();
#endif
