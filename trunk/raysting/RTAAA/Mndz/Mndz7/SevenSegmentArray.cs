...
namespace DmitryBrant.CustomControls
{
    public class SevenSegmentArray : UserControl
    {
        public SevenSegmentArray()
        {
            ...
            this.TabStop = false;
            elementPadding = new Mndz7.Padding(4, 4, 4, 4);
            RecreateSegments(4);
        }
        ...
        /// </summary>
        private void ResizeSegments(bool init)
        {
            ...
            for (int i = 0; i < segments.Length; i++)
            {
                ...
                if(!init)
                {
                    segments[i].gridHeight = this.Height - segments[i].Padding.Vertical;
                    if(segments[i].gridHeight > 50)
                        segments[i].gridWidth = segWidth - segments[i].Padding.Horizontal - ElementWidth;
                    else
                        segments[i].gridWidth = segWidth - segments[i].Padding.Horizontal;
        ...
        private void SevenSegmentArray_Resize(object sender, EventArgs e) { ResizeSegments(false); }
        ...
        private Mndz7.Padding elementPadding;
        ...
        /// </summary>
        public Mndz7.Padding ElementPadding { get { return elementPadding; } set { elementPadding = value; UpdateSegments(); } }
