...
const char* CZxHandler::PathQuery(int clsid,int pathid)
{
	const char*	pathdef[][3]={
				/*MDB*/		/*JS*/							/*GROUP*/
	/*REG	*/	"reg",		"\\Html\\imgorg\\reg.js",		"*",	
	/*DATA	*/	"zxdata",	"\\Html\\imgorg\\zxdata.js",	"*",	
	/*JH	*/	"jh",		"\\Html\\imgorg\\zxjh.js",		"zx",	
	/*REPORT*/	"*",		"\\Html\\imgorg\\report.js",	"*",	
	/*TEST	*/	"*",		"\\Html\\imgorg\\zxtest.js",	"*",	
	/*CONF1	*/	"conf",		"\\Html\\imgorg\\zxconf1.js",	"zxconf1",	
	/*CONF2	*/	"conf",		"\\Html\\imgorg\\zxconf2.js",	"zxconf2",	
...
bool CZxHandler::Handler(CString spage,CString op,CString scmd)
{
	return CHtmlHandler::Handler(spage,op,scmd);
}

bool CZxHandler::ReportHandler(CString op,CString scmd)
{	
	return CHtmlHandler::ReportHandler(op,scmd);
}
bool CZxHandler::DataHandler(CString op,CString scmd)
{
...
bool CZxHandler::JhHandler(CString op,CString scmd)
{
	return CHtmlHandler::JhHandler(op,scmd);
}
bool CZxHandler::TestHandler(CString op,CString scmd)
{
	return CHtmlHandler::TestHandler(op,scmd);
}

bool CZxHandler::Configure1Handler(CString op,CString scmd)
{
	return CHtmlHandler::Configure1Handler(op,scmd);
}
bool CZxHandler::Configure2Handler(CString op,CString scmd)
{
	return CHtmlHandler::Configure2Handler(op,scmd);
}

bool CZxHandler::RegHandler(CString op,CString scmd)
{
...
void CZxHandler::DataIntegrateForCheck(CMapStringToString& mstr,int indexmax,bool colormark)
{
...
void CZxHandler::DataIntegrateForCompensate(CMapStringToString& mstr,int indexmax)
{
	mstr.SetAt("0.005","0");	mstr.SetAt("0.01","1");	mstr.SetAt("0.02","2");
	mstr.SetAt("0.05","3");		mstr.SetAt("0.1","4");	mstr.SetAt("0.2","5");
	mstr.SetAt("0.5","6");		mstr.SetAt("1","7");	mstr.SetAt("2","8");
...
void CZxHandler::PrepareArrayForReport(CMapStringToString& mstr)
{
