...
const char* CDzHandler::PathQuery(int clsid,int pathid)
{
...
bool CDzHandler::Handler(CString spage,CString op,CString scmd)
{
	return CHtmlHandler::Handler(spage,op,scmd);
}

bool CDzHandler::ReportHandler(CString op,CString scmd)
{	
	return CHtmlHandler::ReportHandler(op,scmd);
}
bool CDzHandler::DataHandler(CString op,CString scmd)
{
...
bool CDzHandler::JhHandler(CString op,CString scmd)
{
	return CHtmlHandler::JhHandler(op,scmd);
}
bool CDzHandler::TestHandler(CString op,CString scmd)
{
	return CHtmlHandler::TestHandler(op,scmd);
}

bool CDzHandler::Configure1Handler(CString op,CString scmd)
{
	return CHtmlHandler::Configure1Handler(op,scmd);
}
bool CDzHandler::Configure2Handler(CString op,CString scmd)
{
	return CHtmlHandler::Configure2Handler(op,scmd);
}

bool CDzHandler::RegHandler(CString op,CString scmd)
{
...
void CDzHandler::DataIntegrateForCheck(CMapStringToString& mstr,int indexmax,bool colormark)
{
...
void CDzHandler::DataIntegrateForCompensate(CMapStringToString& mstr,int indexmax)
{
	mstr.SetAt("0.005","0");	mstr.SetAt("0.01","1");	mstr.SetAt("0.02","2");
	mstr.SetAt("0.05","3");		mstr.SetAt("0.1","4");	mstr.SetAt("0.2","5");
	mstr.SetAt("0.5","6");		mstr.SetAt("1","7");	mstr.SetAt("2","8");
...
void CDzHandler::PrepareArrayForReport(CMapStringToString& mstr)
{
