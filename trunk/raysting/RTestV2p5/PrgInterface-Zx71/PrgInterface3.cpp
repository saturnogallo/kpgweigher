...
PRGINTERFACE_API const char*  PathQuery(int pathid, int clsid)
{
	const char*	pathdef[]={
		...
		/*REG	*/	"reg",		"*",							"zx71",	
		/*DATA	*/	"data",	"*",	"*",	
		/*JH	*/	"jh",		"\\Html\\imgorg\\zx71jh.htm",	"zx71",	
		/*REPORT*/	"*",		"*",							"*",	
		/*TEST	*/	"*",		"\\Html\\imgorg\\zx71test.htm",	"*",	
		/*CONF	*/	"conf",		"*",							"conf",	
		/*TBR	*/	"*",		"*",			"*",	
		/*WAIT  */	"*",		"\\Html\\wait.htm",				"*",
		/*TYPE*/  	"*",        	"ZX71",					"ZX71双桥标准电阻箱测量"
	};        
	return pathdef[(clsid-1)*3+pathid-1];
}
PRECBASE2 g_Cfg[] = {
	{PREC_TYPE_RGROUP,41,51,40,"0.01","jhsel5",JHSEL_0005_50,"-22",MANTI_13_1,PREC_5E5_5E1,NULL,"比较臂第{rel_pos}点不合格"},
